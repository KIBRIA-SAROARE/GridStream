###########################################################################
## Makefile generated for component 'LSE_Metric'. 
## 
## Makefile     : LSE_Metric.mk
## Generated on : Sat Nov 15 01:52:59 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\LSE_Metric.exe
...
COMPILER_COMMAND_FILE     = LSE_Metric_comp.rsp
CMD_FILE                  = LSE_Metric.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\LSE_Metric.exe
...
DEFINES_STANDARD = -DMODEL=LSE_Metric -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\LSE_Metric_grt_rtw\LSE_Metric.cpp $(START_DIR)\LSE_Metric_grt_rtw\rtGetInf.cpp $(START_DIR)\LSE_Metric_grt_rtw\rtGetNaN.cpp $(START_DIR)\LSE_Metric_grt_rtw\rt_nonfinite.cpp
...
OBJS = LSE_Metric.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\LSE_Metric_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LSE_Metric_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LSE_Metric_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LSE_Metric_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
LSE_Metric.obj : "$(START_DIR)\LSE_Metric_grt_rtw\LSE_Metric.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LSE_Metric_grt_rtw\LSE_Metric.cpp"


rtGetInf.obj : "$(START_DIR)\LSE_Metric_grt_rtw\rtGetInf.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LSE_Metric_grt_rtw\rtGetInf.cpp"


rtGetNaN.obj : "$(START_DIR)\LSE_Metric_grt_rtw\rtGetNaN.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LSE_Metric_grt_rtw\rtGetNaN.cpp"


rt_nonfinite.obj : "$(START_DIR)\LSE_Metric_grt_rtw\rt_nonfinite.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LSE_Metric_grt_rtw\rt_nonfinite.cpp"
